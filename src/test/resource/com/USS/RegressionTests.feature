...
Feature: To test the functionality of Appication as described in Jira Stories for Iteration 1
  ...
  Scenario Outline: User views the menu items, Test 1, DUSSP-245, DUSSP-533, DUSSP-832 Description: User views the menu items Epic: Common Components
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Accounts   | Residential: Electricity | Account No. 2411617223 | 2250 E Loop 820, Fort Worth |
  ...
  Scenario Outline: Check Usage Menu Item List Test 1, DUSSP-245 Description: User views the menu items Epic: Common Components
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | USAGE      | Residential: Electricity | Usage History | Contact Us  |
  ...
  Scenario Outline: Check User Menu Item List Test 1, DUSSP-745 Description: check for feature under development
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Set Up Direct Debit |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Set Up eBilling     |

  # | USS        | UserNameInput | PasswordInput | christian | Aussie11 | View Current Bill        |
  @review
  Scenario Outline: Test20, Test21, Test22, Test23, Test24, Test26, Check Billing history page elements.
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | ButtonName      | ServiceName              | ButtonName2                                                 | ButtonName3   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | BILLING HISTORY | Residential: Electricity | Apt. 201, 300 Mission Street, San Francisco, CA, 94105 2603 | Usage History |
  ...
  Scenario Outline: DUSSP-422, 423, PAYMENTS
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Account 5104310217 | AccountComboBox | 2250 E Loop 820, Fort Worth | PremiseComboBox | CurrentBillCost | LastBillCost | BillingAccountAmount | LastBillNegativeRedBill |
  ...
  Scenario Outline: Covers tests around Usage History check, Scenario 189
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 |
  ...
  Scenario Outline: DUSSP-450,DUSSP-451,DUSSP-457, PAYMENTS, To make payment from RHS "PAY" button.
    ...
    And I enter the details as
      ...
      | PasswordInput | <Password> |
    And I hit Enter
    And I click on button with value "<ButtonName>"
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        |     689608083 |               | christian Test | 4007000000027 |           11 |          20 |           112 | Mandatory field!                   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        |     689608083 |            20 |                | 4007000000027 |           11 |          20 |           112 | Mandatory field!                   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        |     689608083 |            20 | christian Test |               |           11 |          20 |           112 | Mandatory field!                   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        |     689608083 |            20 | christian Test | 4007000000027 |              |          20 |           112 | Mandatory field!                   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        |     689608083 |            20 | christian Test | 4007000000027 |           11 |             |           112 | Mandatory field!                   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        |     689608083 |            20 | christian Test | 4007000000027 |           11 |          20 |               | Mandatory field!                   |
  ...
  Scenario Outline: DUSSP-162, DUSSP-236 edit settings
    ...
    #And I click on button with value "Edit Settings"
    And I click on button with value "Edit Settings"
  ...
  Scenario Outline: DUSSP-433, DUSSP-550 (reset password is manual), DUSSP-162 Edit Settings>> reset pwd
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Aussie11         | Aussie11     | TEST                 | New Password and Confirm Password do not match. Please try again. |
  ...
  Scenario Outline: DUSSP-413 Scenario 1: User accesses the registration page
    ...
    Examples: 
      ...
      | USS        |     3900923980 | Joy, Vance   | 234567817 | abc        | Your password is not strong enough. |                    123 |
      | USS        |     3900923980 | Joy, Vance   | 234567817 | mattlara   | Your password is not very secure.   |                    123 |
      | USS        |     3900923980 | Joy, Vance   | 234567817 | USSPhase1  | Your password is strong.            |                    123 |
      | USS        |     3900923980 | Joy, Vance   | 234567817 | USSPhase@1 | Your password is very secure!       |                    123 |
  ...
  Scenario Outline: DUSSP-450; DUSSP-457; DUSSP-451: Scenario 1, Scenario 2 Test 1, To make payment from LHS
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | ButtonName | AccountNumber      | PaymentAmount | Name on Card   | Card Number   | Expiry Month | Expiry Year | Security Code | Message                            |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        | Account 1071805034 |               | christian Test | 4007000000027 |           11 |          20 |           112 | Mandatory field!                   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        | Account 1071805034 |            20 | christian Test |               |           11 |          20 |           112 | Mandatory field!                   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        | Account 1071805034 |            20 | christian Test | 4007000000027 |           11 |             |           112 | Mandatory field!                   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        | Account 1071805034 |            20 | christian Test | 4007000000027 |           11 |          20 |               | Mandatory field!                   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        | Account 1071805034 |            20 | christian Test |    4007000000 |           11 |          20 |           112 | The credit card number is invalid. |
  ...
  Scenario Outline: 
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        | Account 1071805034 |          0.11 | christian Test | 4007000000027 |           11 |          20 |           112 |
  ...
  Scenario Outline: DUSSP-450; DUSSP-457; DUSSP-451: Scenario 1, Scenario 2 Test 1, To make payment from LHS
    ...
    And I click on button with value "Make Another Payment"
    And I check I am on "MakePayment" page

    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | ButtonName | AccountNumber      | PaymentAmount | Name on Card    | Card Number   | Expiry Month | Expiry Year | Security Code |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        | Account 1071805034 |            10 | another payment | 4007000000027 |           11 |          20 |           112 |
  ...
  Scenario Outline: DUSSP-493 :As a user I want to login to the USS using my email address so that I can access my information
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | test3@dbresults.com.au | blah_blah@gmail.com | Invalid Username, Email or Password. Please try again. |
  ...
  Scenario Outline: DUSSP-414: As a user I want to enter my user details so that I can complete the registration process
    ...
    #   Then I see "Please wait while we retrieve your account..." displayed
    And I check I am on "Registration" page
    And I click on button "PasswordInfoIcon"
    ...
    And I click on button "HintInfoIcon"
    ...
    Examples: 
      ...
      | USS        |      8970235184 | Pan, Peter | 234567812 | ellen.truefeldt@Dbresults.com.au | PeterPan1        | Aussie11         | Aussie11          | life is life | LanguagePreference | English (UK)   | ellentruefeldt | Aussie111        | Aussie111         | ellen.truefeldt2@gmail.com | bob              | Aussie111        | Aussie111         | TestUser4        | dbr              | dbr               | Aussie111        | hi                |
  ...
  Scenario Outline: DUSSP-450; DUSSP-457; DUSSP-451; DUSSP-492: Scenario 1, Scenario 2 Test 1, To make payment from LHS; DUSSP-459: scenario 1, 2, 3
    ...
    And I click on button with value "Go To Activity History"
    And I check I am on "Activity History" page

    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | ButtonName | AccountNumber      | PaymentAmount | Name on Card | Card Number   | Expiry Month | Expiry Year | Security Code |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Pay        | Account 1071805034 |            20 | happy Test   | 4007000000027 |           11 |          20 |           112 |
  ...
  Scenario Outline: DUSSP-489 As a user I want my name displayed in the portal so that I know I'm currently logged in
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | Welcome, CHRISTIAN |
  ...
  Scenario Outline: DUSSP-449: all (Edit phone and mailing address); DUSSP-553: covers update of info (excludes ccb check)
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | (999) 11-g     | (999) 989-1122    | (888) 777-6654    | (903) 888-7161 | (99) 77-60        | (88) 71           | Apt. 26, 30 Saint Francis Pl |               | San Francisco | CA    |     94107 | United States of America | CountriesComboBox | email@Aussie11.com.au |
  ...
  Scenario Outline: DUSSP-520: Already registered or already activated
    ...
    Then "<Item>" is displayed as "<ItemName>"
      | Item  | ItemName                                                               |
      | item1 | Your account has already been activated. Please click the link bellow. |
    Then I click on button with value "SIGN IN"
    And I check I am on "Login" page

    Examples: 
      | PortalName | Account Number1 | BillName1  | SSN1        | Account Number2 | BillName2   | SSN2        |
      | USS        |      3900923980 | Joy, Vance | 999-91-1111 |      4415168071 | Test, Simon | 211-02-0091 |
  ...
  Scenario Outline: DUSSP-520: Already registered or already activated and user tries again.
    ...
    Examples: 
      ...
      # | USS        |      9353248310 | Da Vinci, christian | 777-78-7807 |      4415168071 | Test, Simon | 998-11-1515 | timepass@gmail.com | Simon            | Aussie11       | Aussie11        | life is life | LanguagePreference | English (GB)   |
      | USS        |      9474110792 | Stuart, Shaw | 65432176 |      9474110792 | Shaw,Stuart | 1234-99-321 | timepass@gmail.com | Simon            | Aussie11         | Aussie11          | life is life | LanguagePreference | English (GB)   |
  ...
  Scenario Outline: Continue with 520, Scenario 2: User registers and their account is not activated
    ...
    Examples: 
      ...
      | USS        |     3900923980 | Joy, Vance | 999-91-1111 |
  ...
  Scenario Outline: DUSSP-493 :As a user I want to login to the USS using my email address so that I can access my information. This will keep runing the validations till CAPTCHA
    ...
    Examples: 
      ...
      | USS        | USS2        | UserNameInput | PasswordInput | christian | Aussie11 | test3@dbresults.com.au | blah_blah@gmail.com | Invalid Username, Email or Password. Please try again. |
  ...
  Scenario Outline: DUSSP-758: This is for defect 758, email address should not be duplicated with edit settings option. This should not accept the duplicate email address.
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | hemant.shori@dbresults.com.au |
  ...
  Scenario Outline: DUSSP-117,167,754 : Goals and Targets setting,verification and removal.DUSSP-128. DUSSP-770 Editing Goal
    ...
    Then I click on "Electricity 6912147640 Res"
    Then "<Item>" is displayed as "<ItemName>"
      | Item  | ItemName        |
      | Item3 | Goals & Targets |
      | Item4 | Starter         |
      ...
      | Item7 | Eco             |
      | Item7 | Custom          |
    And I click on button with value "Set Goal"
    Then I see "This goal will be applied for the next 12 months. Your goal tracker will reset to the selected goal. Are you sure you want to update your goals?" displayed on popup and I click "OK"
    ...
    And I hit Enter
    And I check I am on "Dashboard" page
    And I click on button "MenuIcon"
  ...
  Scenario Outline: User changes password with password strength. DUSSP-790 Description: Change password rule
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11   | abc         |                |                  | Your password is not strong enough.        |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11   |      123456 |                |                  | Your password is not strong enough.        |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11   | mattlara    |                |                  | Your password is not very secure.          |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11   | USSPhase1   |                |                  | Your password is strong.                   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11   | USSPhase@1  |                |                  | Your password is very secure!              |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11   | DBResults1  | DBResults1     | ApplesandOranges | Your changes have been saved successfully. |
      | USS        | UserNameInput | PasswordInput | christian | DBResults1 | Aussie11    | Aussie11       | ApplesandOranges | Your changes have been saved successfully. |
  ...
  Scenario Outline: DUSSP-644: Open PDF bill and verify
    ...
    And I hit Enter
    And I check I am on "Dashboard" page
    And I click on button with value "View Current Bill"
  ...
  Scenario Outline: DUSSP-67 : As a user I want to view my account’s financial history so that I can review the account's transactions over a period of time
    ...
    And I click on button with value "All Transactions"
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | hemant.shori@dbresults.com.au | Account 5104310217 | AccountComboBox | Account 6061134434 | Account No. 2754232312 |
  ...
  Scenario Outline: DUSSP-67 : As a user I want to view my account’s financial history is empty Scenario 3
    ...
    Examples: 
      | PortalName | UserNameField | PasswordField | UserName  | Password | email                  |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | mlara@dbresults.com.au |
  ...
  Scenario Outline: DUSSP-730: update Profile Address Scenario 1
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | test@test.com          |                        |                                            |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | test3@dbresults.com.au | DBResult123s@gmail.com | Your changes have been saved successfully. |
  ...
  Scenario Outline: DUSSP-730: update Profile Address Scenario 2
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | test4@test.com         | TestLine | Your changes have been saved successfully. | DBResults   |
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 | test3@dbresults.com.au | TestLine | Your changes have been saved successfully. | DBResults   |
  ...
  Scenario Outline: Testing User Roles DUSSP-929 Description: User should be able to access USSPortal Epic: Portal Admin
    ...
    And I enter the details as
      ...
      | PasswordInput | <Password> |
    And I hit Enter
    Given I want to login to portal "USSAdmin"
    And I check I am on "Invalid Permissions" page

    Examples: 
      | PortalName | UserNameField | PasswordField | UserName | Password |
      | USS        | UserNameInput | PasswordInput | sam      | Aussie   |
  ...
  Scenario Outline: Testing User Roles DUSSP-930 Description: User should be able to access UAP Epic: Portal Admin
    ...
    Examples: 
      ...
      | USS        | UserNameInput | PasswordInput | christian | Aussie11 |
   #Scenario Outline: Testing User Roles DUSSP-929 Description: User should be able to access USSPortal Epic: Portal Admin
    #BOB ACCOUNT does not exist, but christian's does.
    #Given I want to login to portal "<PortalName>"
    #Then "<Item>" is displayed as "<ItemName>"
      #| Item  | ItemName |
      #| item1 | Logo     |
